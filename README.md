...
The original Valenzise implementation (2010) integrates over the union of the ranges ([min(all), max(all)]). This forces the polynomial to extrapolate data where one curve is missing points.
